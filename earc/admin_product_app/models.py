...
class brands(models.Model):
    ...
    brand_category = models.ForeignKey(category, on_delete=models.DO_NOTHING, related_name='brand')
...
class products(models.Model):
    ...
    pro_category = models.ForeignKey(category, on_delete=models.DO_NOTHING, related_name='product')
    pro_brand = models.ForeignKey(brands, on_delete=models.DO_NOTHING, related_name='pro_brand')
