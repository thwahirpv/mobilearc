...
urlpatterns = [
    ...
    path('image/<int:id>/', variant_management.add_variant_image, name='add_varient_image'),
    ...
    path('getcolorname/<int:id>/', variant_management.get_color_name, name='get_color_name'),
    path('size/<int:id>/', variant_management.update_storage, name='edit_storage'),
    path('storage/<str:action>/<int:id>/', variant_management.delete_storage, name='delete_storage')
]
